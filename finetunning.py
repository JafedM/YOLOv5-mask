...
def main(args):
    ...
    model = yolo.YOLOv5(num_classes, model_sizes[args.model_size],
                         img_sizes=args.img_sizes, N=args.N_mask, s=args.s_mask, fine=args.fine).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fine", type=bool, default=False) # Finetunning
